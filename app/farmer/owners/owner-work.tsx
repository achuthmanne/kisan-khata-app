                          ...
                          {work.paymentMode === "both" && (
                            <View style={{ flexDirection: "row", gap: 16, marginLeft: 22 }}>
                              <AppText style={{ fontSize: 13, color: "#6B7280", fontFamily: "Mandali" }}>
                                {language === "te" ? "నగదు" : "Cash"}: <AppText style={{ color: "#1F2937", fontWeight: "600" }}>₹{work.splitCash || work.splitDetails?.cash || 0}</AppText>
                              </AppText>
                              <AppText style={{ fontSize: 13, color: "#6B7280", fontFamily: "Mandali" }}>
                                {language === "te" ? "ఆన్‌లైన్" : "UPI"}: <AppText style={{ color: "#1F2937", fontWeight: "600" }}>₹{work.splitUpi || work.splitDetails?.upi || 0}</AppText>
                              </AppText>
                            </View>
                          )}
                        </View>
                          ...
                          if (work.paymentStatus === "paid") {
                              ...
                              if (work.paymentMode) {
                                  ...
                                  if (work.paymentMode === "both") {
                                      msg += `  • ${language === "te" ? "నగదు" : "Cash"}: ₹${work.splitDetails?.cash || work.splitCash || 0}\n`;
                                      msg += `  • ${language === "te" ? "ఆన్‌లైన్ పే" : "UPI"}: ₹${work.splitDetails?.upi || work.splitUpi || 0}\n`;
                                  }
                              }
                          } else {
