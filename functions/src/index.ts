  ...
  async () => {
    ...
    for (const doc of usersSnap.docs) {
      ...
      if (daysInactive >= 5 && daysInactive < 7) {
        ...
        const rotation = [
          { t: "👥 కూలీల హాజరు వేయండి", b: "ఈరోజు మీ పొలం పనులకు వచ్చిన కూలీల అటెండెన్స్ Kisan Khata లో మార్క్ చేయడం మర్చిపోకండి.", s: "mestri" }, 
          ...
          { t: "🚜 ట్రాక్టర్ కావాలా?", b: "దున్నడానికి లేదా ఇతర పనుల కోసం యంత్రాలు కావాలంటే Agri Connect లో ఇప్పుడే సెర్చ్ చేయండి.", s: "bookings" }, 
          ...
          { t: "💡 రైతులకు కొత్త పథకాలు", b: "ప్రభుత్వం అందిస్తున్న కొత్త సబ్సిడీలు మరియు పథకాల వివరాలు Kisan Khata లో సిద్ధంగా ఉన్నాయి.", s: "schemes" }, 
          { t: "💸 బాకీల వివరాలు", b: "మీరు ఇతరులకు ఇవ్వాల్సిన లేదా మీకు రావాల్సిన పేమెంట్స్ ఒకసారి సరిచూసుకోండి.", s: "mestripayments" },
          { t: "🗺️ పొలాల నిర్వహణ", b: "మీ వివిధ పొలాల్లో జరుగుతున్న పనుల వివరాలను ఎప్పటికప్పుడు అప్డేట్ చేయండి.", s: "fields" },
          { t: "⚙️ యంత్రాల లెక్కలు", b: "మీ ట్రాక్టర్ లేదా ఇతర యంత్రాల ద్వారా వచ్చిన ఆదాయం మరియు ఖర్చులను నమోదు చేయండి.", s: "owners" },
          { t: "🚛 మీ వాహనాల నిర్వహణ", b: "మీ వాహనాలు ఎక్కడెక్కడ పనిచేశాయో డ్రైవర్ల హాజరుతో సహా ట్రాక్ చేయండి.", s: "vechiles" },
          { t: "🧮 స్మార్ట్ క్యాలిక్యులేటర్లు", b: "ఎరువుల మోతాదు, విత్తనాల సంఖ్యను సులభంగా లెక్కించడానికి మన అగ్రి క్యాలిక్యులేటర్ వాడండి.", s: "calculators" },
          { t: "⏰ పనుల అలారం", b: "పొలంలో చేయాల్సిన పనులను మర్చిపోకుండా ఉండటానికి ఇప్పుడే టాస్క్ రిమైండర్ పెట్టుకోండి.", s: "reminders" },
          { t: "🔒 అగ్రి లాకర్", b: "విత్తనాలు, మందుల బిల్లులు మరియు ఇతర ముఖ్యమైన పత్రాలను సేఫ్‌గా డిజిటల్ లాకర్‌లో దాచుకోండి.", s: "locker" },
        ];
